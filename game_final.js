...
/* ================================================================
   1b. 角色台词 + 语音
   ================================================================ */
// 纯文本台词库（语音被冷却挡下时的文字气泡兜底）
// 严格按"谁出杆 + 什么结果"分类，与 VOICE_CLIPS 主客态完全对齐，每条只在该场景出现
const VOICE_LINES = {
  xiaomai: {
    // ===== taunt：玩家打丢没进（纯嘲讽，不含白球/犯规字眼）×10 =====
    taunt: [
      '就这？我还以为你有多厉害呢~',
      '哈哈哈这杆走位，你是想让我笑死好继承我的奶茶吗？',
      ...
      '你这准头……建议去挂个眼科，我帮你挂号',
      '笑死，这杆打得比我奶奶打麻将还随意',
      '啧啧，差一点点哦~就差那么一整个球的距离',
      '没事没事，重在参与嘛，参与奖给你颁一个🏅',
    ],
    // ===== cute：小麦自己打丢没进（自嘲撒娇，不夸玩家）×10 =====
    cute: [
    ...
    // ===== pfoul_other：玩家其它犯规（母球落袋/碰错球/碰黑8）×8 =====
    pfoul_other: [
      '哦豁~犯规了犯规了！白球都哭了你知道吗😂',
      '哎呀母球进袋了……它是不是觉得你的技术配不上它？',
      '犯规咯~按规则换我来打，那我就勉为其难收下这个福利',
      '哇哦犯规了！这下换我了嘿嘿嘿',
      '哎呀白球都进去了……它可能想换个主人',
      '犯规！裁判！他犯规了！（虽然我就是裁判）',
      '你这犯规犯得很有艺术感啊，我给满分💯',
    ...
    // ===== on_bot_foul：小麦自己犯规（找借口）×10 =====
    on_bot_foul: [
      '咳咳……刚才那杆当我没打过，系统bug，绝对是bug',
      '手滑了手滑了！这不怪我，怪重力！',
      '啊这……那个，我刚刚在想今晚吃什么来着',
      '犯规是犯规，我声明一下：我不是菜，我是有个性',
      '好吧我承认这杆打得离谱……但你也不许笑啊！！',
      '这个……刚才有只蚊子干扰了我的发挥！真的！',
...
const Character = (() => {
   ...
   * @param {string} category   分类（taunt/cute/praise/brag/on_win/on_lose/pfoul_empty/pfoul_other/on_bot_foul）
